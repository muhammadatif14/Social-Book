@echo off
echo Starting Jarvis Direct Bridge API...
echo.
...
echo Starting Jarvis Bridge API server...
start cmd /k "python %~dp0jarvis_bridge_api.py"
...
echo.
echo Jarvis Direct Bridge Web Interface started successfully!
