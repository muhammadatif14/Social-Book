# Jarvis Direct Bridge Starter Script

Write-Host "Starting Jarvis Direct Bridge Interface..." -ForegroundColor Cyan
Write-Host ""

# Define paths
$scriptPath = Split-Path -Parent $MyInvocation.MyCommand.Path
$apiPath = Join-Path -Path $scriptPath -ChildPath "jarvis_bridge_api.py"
...
Write-Host "Starting Jarvis Bridge API server..." -ForegroundColor Yellow
...
Write-Host ""
Write-Host "Jarvis Direct Bridge Web Interface started successfully!" -ForegroundColor Cyan
