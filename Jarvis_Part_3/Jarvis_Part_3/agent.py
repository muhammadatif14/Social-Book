    ...
    def __init__(self) -> None:
        super().__init__(instructions=behavior_prompts,
                         tools=[
                            ...
                            open_edge, #ये Edge ओपन करने के लिए है
                            open_website, #ये website खोलने के लिए है
                            search_on_website, #ये website पर search करने के लिए है
                            youtube_control, #ये YouTube control करने के लिए है
                            click_first_video, #ये first video click करने के लिए है
                            close_edge, #ये Edge बंद करने के लिए है
...
async def entrypoint(ctx: agents.JobContext):
    session = AgentSession(
        llm=openai.realtime.RealtimeModel(
            model="gpt-4o-realtime-preview",  # You can change to your preferred model
            voice="ash",                    # You can change to your preferred voice
